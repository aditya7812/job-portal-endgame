  ...
  return (
      ...
      <div className="job-card">
        ...
        <div className="job-card-buttons">
          <button className="search-buttons card-buttons"><Link className="whiteColorClass" to={`/jobs/${jobId}`}>View</Link></button>
          {!isEmployer ? <button className="search-buttons card-buttons-msg" disabled={status || loading} onClick={handleApplyJob}>Apply{/*<Link to={`applyjob/${jobId}`}>
            Apply
            </Link>*/}
          </button> : ''}
        </div>
